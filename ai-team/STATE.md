...
| B-07 | **감사 미수행 11건** — D-021 · D-025 ~ D-034 | 🔴 전부 `.claude/` 를 고쳤고 D-014 요건 ③ 이 비어 있습니다. 감사실 2인 호출 필요 |
...
- 미반영 큐: **1건** — `2026-08-29-6.md` (D-034 호칭 복귀). 노션 「팀 규정」·「팀원 명세」 의 「자비스」 표기도 함께 바꿔야 합니다
