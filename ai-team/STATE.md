...
- **D-021 · D-026 · D-027 · D-028 도 ③ 미충족**입니다. D-025 와 묶어 **6건 일괄 감사**받습니다 (B-07)
...
| B-07 | **감사 미수행 6건** — D-021 · D-025 · D-026 · D-027 · D-028 · D-029 | 🔴 전부 `.claude/` 를 고쳤고 D-014 요건 ③ 이 비어 있습니다. 감사실 2인 호출 필요 |
...
🎙️ 음성: **말로 명령은 `tap` 모드로 가능** · **박수 두 번·상시 마이크는 기능 부재로 불가** (`ai-team/voice.md`)
