...
> ⚠️ **한 가지 한계는 정직하게 적습니다 — 추정이 아니라 실측입니다.**
> 2026-08-29, 팀 파일을 이미 열려 있던 창에 부어 넣은 직후 그 창에서 회의실 스킬을 불러 봤습니다.
> 결과는 **`Unknown skill: meeting-room`**. 서브에이전트·스킬·훅은 **세션이 시작될 때** 읽힙니다.
